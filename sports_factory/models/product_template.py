...
class ProductTemplate(models.Model):
	...
	offers = fields.Selection(
		string="Offers",
		selection=[('five_percent','5% Offer'),('ten_percent','10% Offer'),('twenty_percent','20% Offer')]
		)
	...
	@api.depends("price","offer_available","offers")
